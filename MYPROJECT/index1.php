...
$quer = "SELECT * FROM product LIMIT 3";
$querr = "SELECT * FROM product ";
            ...
            <form action="" method="POST" style="display: flex;">
                ...
                <div class="card">
                    ...
                    <div class="cardx">
                        ...
                        <p><input type="hidden" name="pimage" value=<?php echo base64_encode($rows['Product_image']); ?>>
                        </p>
        ...
        <center>
            ...
            while ($rows = $result1->fetch_assoc()) {
                ...
                <form action="" method="POST">
                    ...
                    <div class="card1">
                        <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($rows['Product_image']); ?>"
                            alt="Denim Jeans" style="padding-top: 21px; width: 302px; height: 211px">
                        <h1 class="Name">
                            <?php echo $rows['Product_name']; ?>
                        </h1>
                        <p class="price">
