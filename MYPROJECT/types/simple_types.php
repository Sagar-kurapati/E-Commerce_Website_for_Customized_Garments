...
<body>
    ...
    <section id="product">
        ...
        <form method="POST">
            <Center>
                <h1 class="Name">Select Design Type :</h1>
            </Center>

            <div class="card">

                <img src="../pics/Black_T-shirt.jfif" alt="Denim Jeans"
                    style="padding-top: 21px; width: 500px; height: 211px;">
                <h1>Plain</h1>
                <p class="detail"></p>
                <input id="inp" type="button" value="Select" onclick="location.href='./plain.php';" />
            </div>
            <div class="card">

                <img src="../pics/cotton green.webp" alt="Denim Jeans"
                    style="padding-top: 21px; width: 500px; height: 211px;">
                <h1>Strip</h1>
                <p class="detail"></p>
                <input id="inp" type="button" value="Select" onclick="location.href='./strip.php';" />
            </div>

            <div class="card">

                <img src="../pics/p.webp" alt="Denim Jeans" style="padding-top: 21px; width: 500px; height: 211px;">
                <h1>Peacock Feather</h1>
                <p class="detail"></p>
                <input id="inp" type="button" value="Select" onclick="location.href='./peacock.php';" />
            </div>

            <div class="card">

                <img src="../pics/f.webp" alt="Denim Jeans" style="padding-top: 21px; width: 500px; height: 211px;">
                <h1>Strip full handed</h1>
                <p class="detail"></p>
                <input id="inp" type="button" value="Select" onclick="location.href='./fullhanded.php';" />
            </div>
    ...
    <!-- <div class="smallcontainer-cust">
    <div class="cloth">
        <h1 class="title"> Cloth Types</h1>
        <div class="row">
            <div class="col">
    ...
    <div class="cloth1">
        <h1 class="title"> Design Types</h1>
        <div class="row">
            <div class="col">
                <a href="product detail.html"><img src="tshirt.png"></a>
                <a href="product detail.html"><h4>white printed T-shirt</h4></a> 
