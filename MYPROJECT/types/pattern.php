...
<body>
    ...
    <section id="product">
        ...
        <form method="POST">
            <Center>
                <h1 class="Name">Select Pattern  Type :</h1>
            </Center>

            <div class="card">

                <img src="../pics/5.jfif" alt="Denim Jeans" style="padding-top: 21px; width: 500px; height: 211px;">
                <h1>Simple</h1>
                <p class="detail"></p>
                <input id="inp" type="button" value="Select" onclick="location.href='./simple_types.php';" />
            </div>
            <div class="card">
                ...
                <h1>Printed</h1>
                <p class="detail"></p>
                <input id="inp" type="button" value="Select" onclick="location.href='./printed_types.php';" />
            </div>
        </form>
    </section>
